...
- 文件版本：v0.1
- 建立日期：2026-09-15
- 文件狀態：Phase 1 結構基線；功能分冊與內容搬移尚未完成
- 適用專案：`巨亨ONLINE-Nuxt`
...
`WEB-SPEC-02`～`WEB-SPEC-11` 為 Web 功能分冊。每章原則上採用 APP 的 17 節格式；若某節不適用，保留節次並說明理由，不刪除或補寫未確認內容。
...
下表是 Phase 1 的文件骨架，不代表所有檔案目前已建立完成。`WEB-SPEC-01` 使用總綱；功能分冊完成後，再由 HTML 產生器統一收錄。
