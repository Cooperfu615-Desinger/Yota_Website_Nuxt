...
```
# 執行單一腳本（例如更新活動頁）
→ 請 Codex 執行 figma-scripts/01_events_page.js
→ Codex 會使用 mcp__f9553461-75b6-424d-b7eb-2c118c433eb8__use_figma 寫入 Figma

# 執行全部（初始建立或全部重繪）
→ 請 Codex 依序執行 01 → 02 → 03 → 04
```
