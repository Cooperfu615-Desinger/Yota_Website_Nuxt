        ...
        <section v-if="payMethod === 'atm'" class="px-4 mb-5 lg:px-0">
          <div class="card-purple p-4">
            ...
            <div class="flex flex-col gap-3 text-sm">
              <div class="step-item"><div class="step-num">1</div><div style="color:var(--color-text-muted);">選擇儲值方案後，系統將產生專屬轉帳帳號</div></div>
              <div class="step-item"><div class="step-num">2</div><div style="color:var(--color-text-muted);">請在 24 小時內完成轉帳</div></div>
              <div class="step-item"><div class="step-num">3</div><div style="color:var(--color-text-muted);">轉帳完成後約 5–15 分鐘自動到帳</div></div>
            </div>
          </div>
        </section>
      </Transition>
