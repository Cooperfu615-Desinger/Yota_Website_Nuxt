...
export const siteContent = {
  ...
  member: {
    ...
    vipUpgrade: {
      historicalDeposit: 48600,
      historicalWager: 8920000,
      monthlyDeposit: 21500,
      monthlyWager: 428000,
      activeDays: 18,
      highestVip: 6,
    ...
    vipLevels: [
      {
        ...
        name: '鐵牌',
        color: '#94A3B8',
        limit: '一般會員', benefits: ['P2P 手續費 5%', '升級獎勵：無'], rebate: '無', feeDiscount: '現行費率 5%',
        upgradeRequirement: '新註冊', maintainRequirement: '無條件保級', historicalDeposit: null, monthlyWager: null, monthlyDeposit: null, activeDays: null, upgradeReward: '無', p2pFee: '5%',
      },
      {
        level: 1,
        name: '銅牌',
        color: '#CD7F32',
        limit: '入門會員', benefits: ['P2P 手續費 5%', '升級獎勵：銅幣 1,000'], rebate: '無', feeDiscount: '現行費率 5%',
        upgradeRequirement: '歷史儲值 1,000 金幣 AND 當月投注 10,000 金幣', maintainRequirement: '無條件保級', historicalDeposit: 1000, monthlyWager: 10000, monthlyDeposit: null, activeDays: null, upgradeReward: '銅幣 1,000', p2pFee: '5%',
      },
      {
        level: 2,
        name: '銀牌',
        color: '#C0C0C0',
        limit: '進階會員', benefits: ['P2P 手續費 5%', '升級獎勵：銅幣 5,000'], rebate: '無', feeDiscount: '現行費率 5%',
        upgradeRequirement: '條件待設定', maintainRequirement: '無條件保級', historicalDeposit: null, monthlyWager: null, monthlyDeposit: null, activeDays: null, upgradeReward: '銅幣 5,000', p2pFee: '5%',
      },
      {
        level: 3,
        name: '金牌',
        color: '#F5C842',
        limit: '黃金會員', benefits: ['P2P 手續費 5%', '升級獎勵：銀幣 100'], rebate: '無', feeDiscount: '現行費率 5%',
        upgradeRequirement: '歷史儲值 5,000 金幣 AND 當月投注 50,000 金幣', maintainRequirement: '月儲值 2,500 金幣 AND 月投注 25,000 金幣 AND 活躍 8 天', historicalDeposit: 5000, monthlyWager: 50000, monthlyDeposit: 2500, activeDays: 8, upgradeReward: '銀幣 100', p2pFee: '5%',
      },
      {
        level: 4,
        name: '白金',
        color: '#60A5FA',
        limit: '白金會員', benefits: ['P2P 手續費 5%', '升級獎勵：銀幣 250'], rebate: '無', feeDiscount: '現行費率 5%',
        upgradeRequirement: '歷史儲值 10,000 金幣 AND 當月投注 100,000 金幣', maintainRequirement: '月儲值 5,000 金幣 AND 月投注 50,000 金幣 AND 活躍 12 天', historicalDeposit: 10000, monthlyWager: 100000, monthlyDeposit: 5000, activeDays: 12, upgradeReward: '銀幣 250', p2pFee: '5%',
      },
      {
        level: 5,
        name: '琥珀',
        color: '#A855F7',
        limit: '琥珀會員', benefits: ['P2P 手續費 5%', '升級獎勵：銀幣 500'], rebate: '無', feeDiscount: '現行費率 5%',
        upgradeRequirement: '歷史儲值 20,000 金幣 AND 當月投注 200,000 金幣', maintainRequirement: '月儲值 10,000 金幣 AND 月投注 100,000 金幣 AND 活躍 16 天', historicalDeposit: 20000, monthlyWager: 200000, monthlyDeposit: 10000, activeDays: 16, upgradeReward: '銀幣 500', p2pFee: '5%',
      },
      {
        level: 6,
        name: '翡翠',
        color: '#EC4899',
        limit: '翡翠會員', benefits: ['P2P 手續費 5%', '升級獎勵：銀幣 1,000'], rebate: '無', feeDiscount: '現行費率 5%',
        upgradeRequirement: '歷史儲值 35,000 金幣 AND 當月投注 350,000 金幣', maintainRequirement: '月儲值 18,000 金幣 AND 月投注 180,000 金幣 AND 活躍 16 天', historicalDeposit: 35000, monthlyWager: 350000, monthlyDeposit: 18000, activeDays: 16, upgradeReward: '銀幣 1,000', p2pFee: '5%',
      },
      {
        level: 7,
        name: '藍寶石',
        color: '#F472B6',
        limit: '藍寶石會員', benefits: ['P2P 手續費 5%', '升級獎勵：銀幣 1,800'], rebate: '無', feeDiscount: '現行費率 5%',
      ...
      },
      {
        ...
        name: '紅寶石',
        color: '#C084FC',
        limit: '紅寶石會員', benefits: ['P2P 手續費 5%', '升級獎勵：銀幣 2,800'], rebate: '無', feeDiscount: '現行費率 5%',
        upgradeRequirement: '歷史儲值 80,000 金幣 AND 當月投注 800,000 金幣', maintainRequirement: '月儲值 40,000 金幣 AND 月投注 400,000 金幣 AND 活躍 20 天', historicalDeposit: 80000, monthlyWager: 800000, monthlyDeposit: 40000, activeDays: 20, upgradeReward: '銀幣 2,800', p2pFee: '5%',
      },
      {
        level: 9,
        name: '鑽石',
        color: '#818CF8',
        limit: '鑽石會員', benefits: ['P2P 手續費 5%', '升級獎勵：銀幣 4,000'], rebate: '無', feeDiscount: '現行費率 5%',
        upgradeRequirement: '歷史儲值 100,000 金幣 AND 當月投注 1,000,000 金幣', maintainRequirement: '月儲值 50,000 金幣 AND 月投注 500,000 金幣 AND 活躍 24 天', historicalDeposit: 100000, monthlyWager: 1000000, monthlyDeposit: 50000, activeDays: 24, upgradeReward: '銀幣 4,000', p2pFee: '5%',
      },
      {
        level: 10,
        name: '黑耀',
        color: '#F5C842',
        limit: '黑耀會員', benefits: ['P2P 手續費 5%', '升級獎勵：銀幣 6,000'], rebate: '無', feeDiscount: '現行費率 5%',
        upgradeRequirement: '歷史儲值 150,000 金幣 AND 當月投注 2,000,000 金幣', maintainRequirement: '月儲值 75,000 金幣 AND 月投注 1,000,000 金幣 AND 活躍 24 天', historicalDeposit: 150000, monthlyWager: 2000000, monthlyDeposit: 75000, activeDays: 24, upgradeReward: '銀幣 6,000', p2pFee: '5%',
      },
      {
        level: 11, name: '宗師', color: '#14B8A6', limit: '宗師會員', benefits: ['P2P 手續費 5%', '升級獎勵：銀幣 10,000'], rebate: '無', feeDiscount: '現行費率 5%',
        upgradeRequirement: '歷史儲值 250,000 金幣 AND 當月投注 3,500,000 金幣', maintainRequirement: '月儲值 120,000 金幣 AND 月投注 1,750,000 金幣 AND 活躍 25 天', historicalDeposit: 250000, monthlyWager: 3500000, monthlyDeposit: 120000, activeDays: 25, upgradeReward: '銀幣 10,000', p2pFee: '5%',
      },
      {
        level: 12, name: '王者', color: '#22D3EE', limit: '王者會員', benefits: ['P2P 手續費 5%', '升級獎勵：銀幣 18,000'], rebate: '無', feeDiscount: '現行費率 5%',
        upgradeRequirement: '歷史儲值 400,000 金幣 AND 當月投注 6,000,000 金幣', maintainRequirement: '月儲值 200,000 金幣 AND 月投注 3,000,000 金幣 AND 活躍 25 天', historicalDeposit: 400000, monthlyWager: 6000000, monthlyDeposit: 200000, activeDays: 25, upgradeReward: '銀幣 18,000', p2pFee: '5%',
      },
      {
        level: 13, name: '傳奇', color: '#818CF8', limit: '傳奇會員', benefits: ['P2P 手續費 5%', '升級獎勵：銀幣 30,000'], rebate: '無', feeDiscount: '現行費率 5%',
        upgradeRequirement: '歷史儲值 650,000 金幣 AND 當月投注 10,000,000 金幣', maintainRequirement: '月儲值 320,000 金幣 AND 月投注 5,000,000 金幣 AND 活躍 26 天', historicalDeposit: 650000, monthlyWager: 10000000, monthlyDeposit: 320000, activeDays: 26, upgradeReward: '銀幣 30,000', p2pFee: '5%',
      },
      {
        level: 14, name: '神話', color: '#A78BFA', limit: '神話會員', benefits: ['P2P 手續費 5%', '升級獎勵：銀幣 50,000'], rebate: '無', feeDiscount: '現行費率 5%',
        upgradeRequirement: '歷史儲值 1,000,000 金幣 AND 當月投注 16,000,000 金幣', maintainRequirement: '月儲值 500,000 金幣 AND 月投注 8,000,000 金幣 AND 活躍 26 天', historicalDeposit: 1000000, monthlyWager: 16000000, monthlyDeposit: 500000, activeDays: 26, upgradeReward: '銀幣 50,000', p2pFee: '5%',
      },
      {
        level: 15, name: '至尊', color: '#FACC15', limit: '至尊會員', benefits: ['P2P 手續費 5%', '升級獎勵：銀幣 88,888'], rebate: '無', feeDiscount: '現行費率 5%',
        upgradeRequirement: '歷史儲值 1,500,000 金幣 AND 當月投注 25,000,000 金幣', maintainRequirement: '月儲值 750,000 金幣 AND 月投注 12,500,000 金幣 AND 活躍 28 天', historicalDeposit: 1500000, monthlyWager: 25000000, monthlyDeposit: 750000, activeDays: 28, upgradeReward: '銀幣 88,888', p2pFee: '5%',
      },
    ] satisfies VipLevel[],
    historyItems: [
